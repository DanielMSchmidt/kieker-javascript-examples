...
(function(window) {
	...
	kieker.config({"serverUrl":"http://localhost:8000","entryFile":"./js/helpers.js","files":[{"cwd":"js","dest":"build","src":"**/*.js"}],"output":"./instrumentedExample.js","workerOutput":"./worker.js","advices":[{"type":"function","implementation":{}},{"type":"environment","include":["os","version","name"],"implementation":{}}],"writer":[{"type":"console","logLevel":"info"}],"workerUrl":"http://localhost:8000/worker.js"});
