...
},{"kieker-javascript-advice-environment":2,"kieker-javascript-advice-function":3,"kieker-javascript-core":5}],2:[function(require,module,exports){
'use strict';
...
module.exports = function (kieker) {
	var handle = {
		apply: function (target, thisArg, argumentsList) {
			var methodName = target.name || 'anonymous';
	...
	kieker.instrumentFunction = function (target) {
		if (!target) {
			return;
		}
