window.messages = window.kieker.instrumentMethod({
  next: window.kieker.instrumentMethod({
    'en': 'Next',
    'de': 'Weiter',
    'fr': 'Suivant',
    'pt-br': 'Próximo',
  ...
  labelFooter: window.kieker.instrumentMethod({
  ...
  labelLevel: window.kieker.instrumentMethod({
    'en': 'Level',
    'de': 'Level',
    'fr': 'Niveau',
    'pt-br': 'Nível',
  ...
  labelOf: window.kieker.instrumentMethod({
    'en': 'of',
    'de': 'von',
    'fr': 'de',
    'pt-br': 'de',
  ...
  title: window.kieker.instrumentMethod({
  ...
  labelReset: window.kieker.instrumentMethod({
    'en': 'Reset',
    'de': 'Zurücksetzen',
    'fr': 'Réinitialiser',
    'pt-br': 'Reinicializar',
  ...
  warningReset: window.kieker.instrumentMethod({
