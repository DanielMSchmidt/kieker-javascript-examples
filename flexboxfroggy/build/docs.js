window.docs = window.kieker.instrumentMethod({
  'align-content': window.kieker.instrumentMethod({
  ...
  'align-items': window.kieker.instrumentMethod({
  ...
  'align-self': window.kieker.instrumentMethod({
  ...
  'flex-direction': window.kieker.instrumentMethod({
  ...
  'flex-flow': window.kieker.instrumentMethod({
  ...
  'flex-wrap': window.kieker.instrumentMethod({
  ...
  'justify-content': window.kieker.instrumentMethod({
  ...
  'order': window.kieker.instrumentMethod({
